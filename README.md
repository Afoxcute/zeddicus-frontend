# Rock-Paper-Scissors on RSK Testnet

This is a decentralized Rock-Paper-Scissors game built on the RSK Testnet network. The application allows users to create and join games, track their move history, and view past game results, all while ensuring transparency and fairness through blockchain technology.
...
- **Game Tab**: 
  - **Create Game**: Users can create a game by selecting the game type (Lightning Duel, Warrior Clash, Epic Announcement) and setting a stake in tRBTC.
...
- **Frontend**: Built with Next.js, utilizing React for the UI and Wagmi for RSK Testnet interactions.
- **Smart Contracts**: The game logic is implemented in Solidity, ensuring secure and transparent gameplay.
- **Blockchain**: All game states and transactions are recorded on the RSK Testnet network.
